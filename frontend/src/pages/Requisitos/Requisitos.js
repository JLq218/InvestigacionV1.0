        ...
        <Transition animation="fade down" duration={800} visible={visible}>
          <div>
            ...
            <p className="descripcionPage">
              ...
              importante destacar que una vez{" "}
              <b>marcados todos los requisitos</b> en la lista, se{" "}
              <b>habilitará el botón para iniciar el procedimiento</b>. Esta
              medida se implementa con el objetivo de garantizar que la carga de
              los formularios se realice{" "}
              <b>sin contratiempos y en un solo paso</b>. Agradecemos de
